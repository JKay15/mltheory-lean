...
| FoML2 | Ch3 | VC dimension / Rademacher complexity 与书中记号对齐 | partial | 2026-02-13 | MIT TOC、`lean-stat-learning-theory`、`lean-rademacher` | `YuanheZ/lean-stat-learning-theory`; `auto-res/lean-rademacher` | 在 `MLTheory.Learning.AdvancedSLT` 建 FoML2 记号桥接层。 |
